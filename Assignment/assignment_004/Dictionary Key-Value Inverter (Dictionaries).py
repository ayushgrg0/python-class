...
def invert_dict(d):
    inverted_dict = {}
    for key, value in d.items():  # .items() The items() method in Python dictionaries is used to retrieve a view object that displays a list of key-value pair tuples
